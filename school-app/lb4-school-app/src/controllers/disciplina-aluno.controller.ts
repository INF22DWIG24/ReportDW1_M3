...
export class DisciplinaAlunoController {
  ...
  async find(
    ...
    return this.disciplinaRepository.alunosdisc(id).find(filter);
  }
      ...
      content: {
        'application/json': {
          schema: getModelSchemaRef(Aluno, {
            ...
            exclude: ['id'],
            optional: ['disciplina_id']
          }),
        },
      },
    }) aluno: Omit<Aluno, 'id'>,
  ): Promise<Aluno> {
    return this.disciplinaRepository.alunosdisc(id).create(aluno);
  }
  ...
  async patch(
    ...
    return this.disciplinaRepository.alunosdisc(id).patch(aluno, where);
  }
  ...
  async delete(
    ...
    return this.disciplinaRepository.alunosdisc(id).delete(where);
  }
}
